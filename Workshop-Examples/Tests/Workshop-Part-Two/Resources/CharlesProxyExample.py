...
def start_charles_proxy_in_headless_mode():
    ...
    charles_proxy_configuration_file_path = os.path.join(current_working_directory, "Workshop-Examples", "Tests", "Workshop-Part-Two", "Resources", "com.xk72.generic-original.charles.config")
